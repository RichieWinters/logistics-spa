    ...
    <ExcursionTemplate
      ...
      description={
        <p>
          ...
          <ul className="pl-6">
            <li>-Мегалитическая культура: происхождение мира, появление человека</li>
            <li>-Стоянка древнего человека:эпоха неолита, поселения древних людей в поймах рек Беларуси</li>
            <li>-Площадка славянских культов</li>
            <li>
              -Пристань варягов: реконструированное поселение варяжских путешественников начала эпохи Раннего
              Средневековья
            </li>
            <li>-Путь «из варяг в греки»: путешествие на ладье викингов — «драккаре»</li>
            <li>
              -Беларусь — страна замков: Готический квартал, Сульская Вежа, оружейная кузница, гончарная мастерская
            </li>
            <li>-Коллегиум: экспозиция истории образования и просвещения на белорусских землях</li>
            <li>-Белорусская шляхта: зал шляхетской славы, галерея шляхетских гербов</li>
            <li>
              -Сульская винокурня: производство старки, демонстрационный и дегустационный залы, сульские винные погреба
            </li>
            <li>-Белорусское местечко: травная аптека, белорусское ткачество, еврейский дом, шаповальня, батлейка</li>
            <li>-Усадебная жизнь: усадьбамузей Ленских, флигель, парк, часовня-усыпальница</li>
          </ul>
        </p>
      }
