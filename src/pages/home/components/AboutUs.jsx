        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-100 leading-relaxed">
              Благодаря многолетнему опыту и постоянному обновлению автопарка, мы обеспечиваем высокий уровень качества
              и надежности. Каждая поездка с нами — это гарантия безопасного, комфортного и своевременного прибытия к
              месту назначения.
            </p>
          </div>
